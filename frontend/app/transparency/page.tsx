...
export default function TransparencyPage() {
  const rows = [
    ...
    { date: "2025-09-05", category: "Frontier Science - Research Grant", amount: "$5,000", tx: "0x789…abc" },
  ];
  const costBreakdown = [
    { label: "Frontier Science", value: 78, color: "from-green-500 to-green-400" },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              This page shows how we will report protocol costs and frontier science allocations once NOVA launches. All numbers below are illustrative placeholders while the NOVA Genesis campaign is live.
            </p>
          </motion.div>
          ...
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4 mb-8 text-purple-100 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm leading-relaxed">
                Live wallet addresses, attestations, and CSV downloads will go online with the NOVA launch. Until then, follow the NOVA Genesis plan and reserve NOVA with USDC to mint NOGE advisory tokens.
              </p>
            </div>
            <button
