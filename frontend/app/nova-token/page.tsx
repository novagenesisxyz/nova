...
const roadmap = [
  ...
  },
  {
    ...
    description:
      "Launch ongoing NOVA issuance where most yield funds frontier science programs. Community governance allocates the research budget and sets policy.",
    icon: Shield,
...
const principles = [
  ...
  },
  {
    ...
    description:
      "Protocol costs cover compliance, security, and operations. The majority of yield is reserved for science initiatives curated with community input.",
    icon: Target,
    iconBg: "bg-blue-500/20",
    iconColor: "text-blue-400",
  },
...
const scienceAdvisors = [
  {
    name: "Dr. Craig Knoblock",
    role: "Executive Director, USC ISI",
    focus: "Oversees autonomous science agent roadmap and safety evaluations.",
  },
  {
    name: "Dr. Maria Spiropulu",
    role: "Professor of Physics, Caltech",
    focus: "Advises on quantum instrumentation collaboration between USC ISI and Stanford Quantum Lab.",
  },
  {
    name: "Dr. Pardis Sabeti",
    role: "Lead, Broad Institute Biosurveillance",
    focus: "Guides biosafety data-sharing standards for rapid pathogen detection pilots.",
  },
];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              frontier science. Today we are raising the NOVA Genesis pool so we can build the
                ...
                {scienceAdvisors.map((advisor) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-purple-200">{advisor.role}</p>
                    </div>
                    <p className="text-sm text-gray-300 leading-relaxed">{advisor.focus}</p>
                    <div className="flex items-center gap-2 text-xs text-gray-500">
                      <CheckCircle className="w-4 h-4 text-green-400" />
                      <span>Confirms milestones before funds flow</span>
                    </div>
                  </div>
                ))}
              </div>
