              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-100/80">
                    Project cards, totals, and backer counts are illustrative so supporters can see the future impact flow. Live initiatives will go through diligence before NOVA launches.
                  </p>
                </div>
              </div>
              <button
